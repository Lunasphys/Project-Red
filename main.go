...
func main() {
	...
	char2.Init("Marchand", []string{"Potion de vie", "épée de fer", "Potion de poison", "Boule de feu", "Fourrure de loup", "Peau de troll", "Cuir de Sanglier", "Plume de Corbeau"}, 1000000)
	//char1.TakePot()
	char1.menu(&Marchand{})
}
