...
func (char *monstre) Init(Nom string, Point_de_vie_max int, Point_de_vie_restant int, Point_d_attaque int, Initiative int) { // Informations du monstres
	char.Nom = Nom
